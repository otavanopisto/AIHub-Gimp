...
class AboutDialog(Gtk.Dialog):
    def __init__(self, parent, version):
        super().__init__(title=_("About Gimp AIHub"), parent=parent, flags=0)
        ...
        content_box.pack_start(Gtk.Label(label=_("GIMP AIHub Version: {}").format(version if version else _("unknown"))), False, False, 0)
        ...
        license_label = Gtk.Label(label=_("GIMP AIHub is licensed under the GNU General Public License."))
        ...
        extra_info = AIHubLabel(_("This product has been developed by Otavan Opisto in the city of Mikkeli, Finland; with the purpose of being an educational tool for students learning programming and AI concepts as well as facilitating teachers with AI content generation tools that they can access."))
        content_box.pack_start(extra_info.get_widget(), False, False, 0)

        extra_info_2 = AIHubLabel(_("Any use of the product is at your own risk. Otavan Opisto is not responsible for any damages or losses caused by the use of this product."))
        content_box.pack_start(extra_info_2.get_widget(), False, False, 0)

        extra_info_3 = AIHubLabel(_("Otavan Opisto is not responsible for any content generated by AI models or any actions taken based on such content, AIHub is merely a tool to facilitate access to AI models."))
